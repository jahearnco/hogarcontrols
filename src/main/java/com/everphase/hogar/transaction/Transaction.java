...
public class Transaction {
	  ...
	  public Transaction(BigDecimal amount, Long epochSecs, Long customerId, String userId) {
	    ...
	    this.userId = userId;
	    log.info("Transaction(amount:" + amount + ", epochSecs:" + epochSecs + ", transactionId:" + id + ", customerId:" + customerId + ", userId:" + userId + ") called");
	  }
	  ...
	  public String toString() {
	    return "Transaction{" + "id=" + this.id + ", amount='" + this.amount + "', epochSecs='" + this.epochSecs + "'', rewardsPoints='" + this.rewardsPoints + "', userId='" + this.userId + "'}";
	  }
}