...
public class Customer {
	  ...
	  public Customer(){
	    if (userId == null) userId = "@sanity check: userId null";
	  ...
	  public boolean equals(Object o) {	
	    ...
	    return Objects.equals(this.id, customer.id) && Objects.equals(this.userId, customer.userId) && Objects.equals(this.transactionIds, customer.transactionIds);
	  }
